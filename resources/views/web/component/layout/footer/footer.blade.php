        ...
        <section class="flex flex-col w-[32%] max-md:ml-0 max-md:w-full">
          <div class="flex flex-col items-start w-full min-h-[302px] max-md:mt-10">
            <div class="flex gap-2.5 items-center text-xl leading-loose text-white whitespace-nowrap">
              <img loading="lazy" src="{{ asset('assets/logokedungmundu-removebg-preview 1.png') }}" alt="" class="object-contain shrink-0 self-stretch my-auto w-16 aspect-[0.77]" />
            ...
            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/f8ebc1ca431ff205d2ffe3ab734cdbeefb61e637b0c24c56644723bb11e15294?placeholderIfAbsent=true&apiKey=44c72691d9e444b396339c48bbfbb9c1" alt="Kedungmundu logo" class="object-contain mt-4 max-w-full rounded-none aspect-[5.99] w-[180px]" />
          </div>
        </section>
              ...
              <nav class="flex flex-col ml-5 w-[21%] max-md:ml-0 max-md:w-full">
                <div class="flex flex-col grow items-start text-base text-stone-300 max-md:mt-10">
                  ...
                  <ul class="mt-5 space-y-5">
                    <li><a href="#" class="text-stone-300">Beranda</a></li>
